            ...
            switch (action) {
                ...
                case "manageOrders": {
                    ...
                    if (filterStatus != null && !filterStatus.trim().isEmpty()) {
                        ...
                        for (OrderDTO o : allOrders) {
                            if (filterStatus.equalsIgnoreCase(o.getStatus())) {
                                filtered.add(o);
                            }
                        }
                        allOrders = filtered;
                ...
                case "checkout": {
                    ...
                    if (addressIdStr == null || totalStr == null) {
                        session.setAttribute("MSG_ERROR", "Thiếu thông tin đặt hàng!");
                    ...
                    if (orderDao.create(order)) {
                        ...
                        response.sendRedirect("MainController?action=myOrderDetail&orderId=" + currentOrderId);
                    } else {
