<%-- 
    Document   : wishlist
    Created on : Mar 12, 2026, 4:48:22 AM
    Author     : PC
--%>
        ...
        <div class="container py-5">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <div>
                    ...
                    <h2 class="fw-bold text-dark">Sách <span class="text-primary">Yêu Thích</span></h2>
                    <span class="text-muted"><i class="bi bi-heart-fill text-danger me-1"></i> Lưu giữ những cuốn sách bạn tâm đắc</span>
                </div>
                
                <span class="badge bg-primary rounded-pill px-3 py-2 shadow-sm">
                    ${WISHLIST.size() != null ? WISHLIST.size() : 0} Sản phẩm
                </span>
            </div>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-end pe-3">
                                                    <div class="btn-group shadow-sm">
                                                        <a href="MainController?action=addToCart&id=${item.bookId}" 
                                                           class="btn btn-sm btn-white text-primary border ${item.stock <= 0 ? 'disabled' : ''}" 
                                                           title="Thêm vào giỏ hàng">
                                                            <i class="bi bi-cart-plus-fill"></i>
                                                        </a>
                                                        <a href="MainController?action=bookDetail&id=${item.bookId}" class="btn btn-sm btn-white text-info border" title="Xem chi tiết">
                                        ...
                                        <c:if test="${empty WISHLIST}">
                                            <tr>
                                                <td colspan="4" class="text-center py-5">
                                                    ...
                                                    <p class="small">Hãy dạo quanh cửa hàng và tìm cuốn sách bạn yêu nhé!</p>
                                                    <a href="MainController?action=home" class="btn btn-primary mt-2 shadow-sm">
                                                        Khám phá ngay
                                                    </a>
                                                </td>
                                            </tr>
