<%-- 
    Document   : checkout
    Created on : Mar 12, 2026, 4:49:30 AM
    Author     : PC
--%>
                ...
                <div class="row g-4">
                    <div class="col-lg-7">
                        <div class="card order-card p-4 h-100">
                            <h5 class="fw-bold mb-4 text-uppercase small tracking-wider">
                            ...
                            <h5 class="fw-bold mt-5 mb-4 text-uppercase small tracking-wider">
                                <i class="bi bi-wallet2 me-2 text-primary"></i>Phương thức thanh toán
                            </h5>
                            <div class="row g-2">
                                <div class="col-md-6">
                                    <input type="radio" name="paymentMethod" value="COD" class="btn-check" id="method_cod" checked>
                                ...
                                <div class="col-md-6">
                                    <input type="radio" name="paymentMethod" value="BANK" class="btn-check" id="method_bank">
                    ...
                    <div class="col-lg-5">
                        <div class="card order-card sticky-top shadow-sm" style="top: 100px;">
                            <div class="card-body p-4">
                                <h5 class="fw-bold mb-4 text-uppercase small tracking-wider">Tóm tắt đơn hàng</h5>

                                <div class="mb-4" style="max-height: 250px; overflow-y: auto;">
                                    <c:forEach var="item" items="${sessionScope.CART}">
                                        <div class="d-flex justify-content-between align-items-center mb-3">
                                            <div class="d-flex align-items-center">
                                                <div class="bg-light rounded p-2 me-3" style="width: 40px; height: 50px; text-align: center;">
                                ...
                                <div class="d-flex justify-content-between mb-2 mt-4">
                                    ...
                                    <span class="fw-bold"><fmt:formatNumber value="${sessionScope.TOTAL_PRICE}" pattern="#,###"/> đ</span>
                                </div>
                                ...
                                <div class="bg-primary bg-opacity-10 p-3 rounded-3 mb-4 d-flex justify-content-between align-items-center mt-4">
                                    <span class="fw-bold text-primary">TỔNG CỘNG</span>
                                    <span class="h4 fw-bold text-danger mb-0">
                                        <fmt:formatNumber value="${sessionScope.TOTAL_PRICE}" pattern="#,###"/> đ
                                    </span>
                                </div>
